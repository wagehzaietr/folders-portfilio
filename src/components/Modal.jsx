                      ...
                      >
                        ...
                        >
                          ...
                          <motion.button
                            ...
                            className={`absolute top-2 right-2 p-2 rounded-full ${isdark ? 'bg-gray-700/80' : 'bg-white/80'}`}
                            whileTap={{ scale: 0.9 }}
                          >
                            <motion.div
                              animate={{
                                scale: likes[project.id] ? [1, 1.2, 1] : 1,
                                color: likes[project.id] ? '#ec4899' : (isdark ? '#9ca3af' : '#6b7280')
                              }}
                            >
                              <FaHeart />
                            </motion.div>
                          ...
                          <div className={`text-3xl mb-3 p-2 flex items-center justify-center backdrop-blur-lg drop-shadow-lg ${
                          ...
                          <p
                            className={`text-sm mb-3 line-clamp-2 ${theme.secondaryText}`}
                          >
                            {project.description}
                          </p>
